...
class Item:
    ...
    Attributes:
        ...
        use_angle_var: Rotational recoil range sampled on a single item use.
    ...
    def __init__(
        ...
        self.use_angle_var = use_angle_var
